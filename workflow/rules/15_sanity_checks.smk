...
rule sanity_checks:
    ...
    output:
        plot_inundation_ratio      = results_path("{basin_id}/scenarios/{scenario}/visuals/spinup/01_inundation_ratio.png"),
        animation_flood_progress   = results_path("{basin_id}/scenarios/{scenario}/visuals/spinup/02_flood_animation.mp4"),
    params:
    ...
    log:
        "logs/{basin_id}/scenarios/{scenario}/15_sanity_checks.log"
    script:
